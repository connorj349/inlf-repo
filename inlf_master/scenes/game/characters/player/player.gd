...
@export var blood_circle_prefab: PackedScene

var role # change this so that the extended player IS the role, instead of this role resource being used
var cam_accel = 40
var blood_circle_active = false
var pickup_object = null

@onready var movement = $Movement # remove this
